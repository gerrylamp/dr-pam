        ...
        <>
            ...
            <section className="bg-indigo-900 text-white text-center py-24 px-6 z-[1] sticky top-0">
                <div ref={ref} className={`${fadeInClass}`} style={style}>
                    <h2 className="text-3xl md:text-4xl font-bold mb-4">Let’s Strengthen Your Ministry</h2>
                    <p className="mb-6 max-w-xl mx-auto">Whether you're launching a ministry, facing a season of transition, or growing your team — I'm here to walk with you.</p>
