        ...
        <>
            ...
            >
                <div ref={ref} className={`fixed ${fadeInClass}`} style={style}>
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">Life & Leadership Coaching</h1>
                    <p className="text-lg max-w-2xl mx-auto">
                        Guiding individuals and teams toward clarity, purpose, and impactful transformation.
                    </p>
                </div>
            </section>
        </>
